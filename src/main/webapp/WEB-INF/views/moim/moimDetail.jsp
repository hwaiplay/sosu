			...
			<table>
				...
				<tbody>
					<c:choose>
						...
						<input type = "hidden" value = "${list2.P_FINAL_YN}" name = "finalyn">
						<input type = "hidden" name = "M_IDX" value = "${list2.M_IDX}" id = "pmidx">
		...
		<div align="center" id="btndiv">
			<c:if
				...
				<form action="/moim/moimJoin.sosu" onsubmit="return checkJoin();">
					...
					<input type="hidden" name="MO_IDX" value="${MO_IDX}">
					<input type="hidden" name="M_GENDER" value="${sessgender}" id = "ssgender"> 
				...
				<form action="/moim/moimJoinPermit.sosu"  onsubmit="return checkJoin2();">
