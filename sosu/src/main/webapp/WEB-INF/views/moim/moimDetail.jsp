...
<main>
      <div class="detailBody">
         <div class="imgArea">
            ...
            <!-- 메인 사진이 없다면 띄워주는 샘플 img-->
            <c:if test="${Detail.MF_SVNAME eq '0' }">
            ...
            <c:if test="${Detail.MF_SVNAME ne '0' }">
               <img src="/resources/img/upload/${Detail.MF_SVNAME}" style="width: 1000px; height: auto;">
            </c:if>
      ...
      만 ${Detail.MO_MINAGE}~${Detail.MO_MAXAGE}세  
      </c:if>
      ...
      <!-- 0127기준 미완 방장 프로필 -->
      <%-- ${Detail.KPROFILE} --%>
      <img src="/resources/assets/img/image/${f.F_SVNAME}" class="kingimg">
      ...
      <p>
    	  <c:if test="${Flist ne null}">
            ...
            <img src="${pageContext.request.contextPath}/resources/img/upload/${fl.F_SVNAME}" style="width: 1000px; height: auto;">  
            </c:if>    
            </c:forEach>
         </c:if>
