...
<h2 style=" margin-top: 90px; margin-bottom: 50px;">모임 수정하기</h2>
   <form role="form" action="/moim/moimModify.pro" method="post" id="f" encType="multipart/form-data" name="moimR">
      ...
      <col style="width:auto;"> 
         ...
         <tr>
            ...
            <c:if test="${modify.MO_MAXAGE == '200'}">
             <input type="hidden" name="MO_MINAGE" id="MO_MINAGE" value="${modify.MO_MINAGE }">
             <input type="hidden" name="MO_MAXAGE" id="MO_MAXAGE" value="${modify.MO_MAXAGE }">
               <div id="ll">제한없음</div>
            </c:if>
            <c:if test="${modify.MO_MAXAGE != '200'}">
          ...
          <tr>
             ...
             <input type="button" id="ageLimit" class="noLB" value="수정하기" style="cursor: pointer; display: none;">
             </td>
          </tr>
            ...
            <c:if test="${modify.MO_MAXPEOPLE != '0' }">
            <input type="text" class="form-control" name="MO_MAXPEOPLE" id="MO_MAXPEOPLE" value="${modify.MO_MAXPEOPLE }">
            </c:if>  
            <c:if test="${modify.MO_MAXPEOPLE == '0' }">
         ...
         <tr>
          <th></th>
          <td>
          <button type="button" id="peopleNoLimit" class="noLB" style="cursor: pointer;
             <c:if test="${modify.MO_MAXPEOPLE == '0' }">display: none;</c:if>">       
             <div>제한 없음</div>
          </button>
          <input type="button" id="pepolemodi" class="noLB" value="수정하기" style="cursor: pointer;display: none;">
          </td>
       </tr>
         ...
         <tr>
            ...
            <td class="contents">
               <input type="time" class="form-control" name="MO_DEADTIME" id="MO_DEADTIME" value="${modify.MO_DEADTIME }" step="900">
            </td>
         </tr>  
         ...
         <tr>
            ...
            <td class="contents">
          <div id = "main" style="display:none;">메인 이미지 <span>
        ...
        <input type="hidden" name="MO_IDX" value="${modify.MO_IDX}">
         <button type="submit" id="delB">수정</button>
         </form>
      </div>
</body>
</html>