...
public class ReviewController {
	...
	public ModelAndView reviewForm_insert(CommandMap commandMap, HttpServletRequest request, HttpSession session) throws Exception {
	...
	@GetMapping("/reviewModify/{RV_IDX}.sosu")
	public ModelAndView reviewModify(@PathVariable int RV_IDX, CommandMap commandMap) throws Exception {
	...
	/*
	 * @PostMapping("/review/reviewModify.sosu") public ModelAndView
	 * reviewModify_(@RequestParam(value="MO_CATEGORY", required=false) String
	 * MO_CATEGORY, CommandMap commandMap, HttpServletRequest request) throws
	 * Exception {
	 * 
	 * Map<String, Object> map = reviewService.reviewDetail(commandMap.getMap());
	 * 
