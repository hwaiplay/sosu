...
public class MoimServiceImpl implements MoimService {
   ...
   // 모임 찜하기
   @Override
   public void moimZzimInsert(Map<String, Object> map, HttpSession session, CommandMap commandMap) throws Exception {
      moimDao.moimZzimInsert(map, session, commandMap);
   }

   // 모임 삭제하기
   @Override
   public void moimZzimDelete(Map<String, Object> map, HttpSession session, CommandMap commandMap) throws Exception {
      moimDao.moimZzimDelete(map, session, commandMap);
   }
